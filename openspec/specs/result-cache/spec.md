...
The result cache stores completed simulation results in localStorage, keyed by a deterministic config fingerprint, enabling instant restoration of previously-run configurations without re-running the Monte Carlo simulation.
