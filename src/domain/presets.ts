  ...
  },
  {
    ...
    pipeline: [
      ...
      },
      {
        ...
        name: 'total_mod',
        source: 'total',
        op: { fn: 'add', terms: [{ operand: 'val', value: { kind: 'ref', name: 'X' } }] },
        comment: '',
      },
    ],
    outcomes: [
    ...
    pipeline: [
      {
        ...
        op: {
          fn: 'filter',
          conditions: {
            clauses: [{ field: 'face', operator: '>=', value: literalExpr(6) }],
            connectors: [],
          },
        },
        comment: '',
      ...
      },
      {
        ...
        op: {
          fn: 'filter',
          conditions: {
            clauses: [{ field: 'face', operator: '=', value: literalExpr(10) }],
            connectors: [],
          },
        },
        comment: '',
      ...
      },
      {
        ...
        name: 'half_crits',
        source: 'crit_count',
        op: { fn: 'divide', terms: [{ operand: 'val', value: literalExpr(2) }] },
        comment: '',
      },
      {
        id: 'p6',
      ...
      },
      {
        ...
        op: { fn: 'add', terms: [{ operand: 'ref', source2: 'double_crits' }] },
        comment: '',
      },
    ],
    outcomes: [
  ...
  },
  {
    ...
    pipeline: [
      ...
      },
      {
        ...
        name: 'delta',
        source: 'hope_value',
        op: { fn: 'subtract', terms: [{ operand: 'ref', source2: 'fear_value' }] },
        comment: '',
      },
      {
        id: 'p6',
    ...
    pipeline: [
      ...
      },
      {
        ...
        op: {
          fn: 'filter',
          conditions: {
            clauses: [{ field: 'face', operator: 'is_max' }],
            connectors: [],
          },
        },
        comment: '',
  ...
  },
  {
    ...
    pipeline: [
      ...
      },
      {
        ...
        name: 'effective',
        source: 'trait_best',
        op: { fn: 'max', operand: 'ref', source2: 'wild_best' },
        comment: '',
      },
    ],
    outcomes: [
