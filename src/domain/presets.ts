  ...
  },
  {
    ...
    pipeline: [
      ...
      },
      {
        ...
        name: 'total_mod',
        source: 'total',
        op: { fn: 'add', terms: [{ operand: 'literal', value: { kind: 'ref', name: 'X' } }] },
        comment: '',
      },
    ],
    outcomes: [
  ...
  },
  {
    ...
    pipeline: [
      ...
      },
      {
        ...
        name: 'half_crits',
        source: 'crit_count',
        op: { fn: 'divide', terms: [{ operand: 'literal', value: literalExpr(2) }] },
        comment: '',
      },
      {
        id: 'p6',
      ...
      },
      {
        ...
        op: { fn: 'add', terms: [{ operand: 'named', source2: 'double_crits' }] },
        comment: '',
      },
    ],
    outcomes: [
  ...
  },
  {
    ...
    pipeline: [
      ...
      },
      {
        ...
        name: 'delta',
        source: 'hope_value',
        op: { fn: 'subtract', terms: [{ operand: 'named', source2: 'fear_value' }] },
        comment: '',
      },
      {
        id: 'p6',
