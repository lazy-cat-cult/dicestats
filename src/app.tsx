    ...
    <div class="min-h-screen flex flex-col">
      <BrandHeader>
        <a
          ...
          class="inline-flex items-center gap-1.5 font-mono text-[11px] uppercase tracking-[0.14em] border border-gold px-3 py-1.5 mr-6 text-paper hover:bg-paper hover:text-billiard transition-all"
